      ...
      <Container fluid>
        <Row>
          <Col md={{span:6, offset:3}}>
            <h2 className="h2" align="center">WELCOME!</h2>
          </Col>
        </Row>
        <Row>&nbsp;</Row>
        <Row>
        ...
        <Row>
          <Col md={{span:6, offset:3}}>
            <Form>
              <Row>
                <Form.Group as={Col} className="mb-3" controlId="formGroupFname" style={{color: 'black'}}>
                    <Form.Label>First Name</Form.Label>
                    <Form.Control type="firstName" placeholder="Enter first name" onChange={(e) => setFirstName(e.target.value)} />
                    {errors.firstName && <span className='text-danger'>{errors.firstName}</span>}
                </Form.Group>
                
                <Form.Group as={Col} className="mb-3" controlId="formGroupLname" style={{color: 'black'}}>
              ...
              <Form.Group className="mb-3" controlId="formGroupPhoneNo" style={{color: 'black'}}>
              ...
              <Row>
                <Form.Group as={Col} className="mb-3" controlId="formGroupNewPassword" style={{color: 'black'}}>
                  <Form.Label>New Password</Form.Label>
                  <Form.Control type="password" placeholder="Enter password" onChange={(e) => setNewPassword(e.target.value)}/>
                  {errors.newPassword && <span className='text-danger'>{errors.newPassword}</span>}
                </Form.Group>
                
                <Form.Group as={Col} className="mb-3" controlId="formGroupConfirmPassword" style={{color: 'black'}}>
            ...
            <Row>
              <p>
                ...
                <Link to="../pages/AuthenticationPage" className="mb-3" style={{color: 'black'}}>
                  Login
                </Link>
              </p>
            </Row>
