  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/pages/AdminPanel/AdminPanelViewEmployees"
          element={<AdminPanelViewEmployees />}
        />
        <Route
          path="/pages/AdminPanel/AdminPanelViewCustomers"
          element={<AdminPanelViewCustomers />}
        />
        <Route
          path="/pages/AdminPanel/AdminPanelViewReports"
          element={<AdminPanelViewReports />}
        />
        <Route
          path="/pages/AdminPanel/AdminPanelViewOrders"
          element={<AdminPanelViewOrders />}
        />
        <Route
          path="/pages/AdminPanel/AdminPanelViewInventory"
          element={<AdminPanelViewInventory />}
        />
        <Route
          path="/pages/AdminPanel/AdminPanelAddEmployees"
          element={<AdminPanelAddEmployees />}
        />
        <Route path="/pages/Profile" element={<Profile />} />
        <Route
          path="/pages/Profile/EditPersonalDetails"
        ...
        <Route
          path="/pages/CartPage/Purchase/Purchase2/:addressId"
          element={<Purchase2 />}
        />
        <Route
          path="/pages/CartPage/StorePickupOrderSaved"
          element={<StorePickupOrderSaved />}
        />
        <Route
          path="/pages/CartPage/DeliveryOrderSaved"
          element={<DeliveryOrderSaved />}
        />
        <Route path="/pages/Profile/OrderReport" element={<OrderReport />} />
        <Route
          path="/pages/SubCategoryPage/:Product_Category_Id/:Category_Name"
          element={<SubCategoryPage />}
        />
        <Route path="/pages/SamplePage" element={<SamplePage />} />
        <Route
          path="/pages/CustomerSubCategoryPage/:Product_Category_Id/:Category_Name"
          element={<CustomerSubCategoryPage />}
        />
        <Route
          path="/pages/ProductsPage/:Product_Category_Id/:Category_Name"
          element={<ProductsPage />}
        />
        <Route
          path="/pages/CustomerProductsPage/:Product_Category_Id/:Category_Name"
          element={<CustomerProductsPage />}
        />
        <Route
          path="/pages/ProductItemPage/:Product_Category_Id/:Category_Name/:Product_Id"
          element={<ProductItemPage />}
        />
        <Route
          path="/pages/VariantItemPage/:Product_Category_Id/:Category_Name/:Product_Id/:selectedVariantID"
          element={<VariantItemPage />}
        />
        <Route
          path="/pages/CustomerProductItemPage/:Product_Category_Id/:Category_Name/:Product_Id"
          element={<CustomerProductItemPage />}
        />
        <Route
          path="pages/CustomerVariantItemPage/:Product_Category_Id/:Category_Name/:Product_Id/:selectedVariantID"
          element={<CustomerVariantItemPage />}
        />
      </Routes>
      {/* <ItemCard image='img' title='sanjana' description='good man' button1Label='a1' button2Label='a2' onClickButton1='c1' onClickButton2='c2' /> */}
    </BrowserRouter>
  );
}
export default App;
