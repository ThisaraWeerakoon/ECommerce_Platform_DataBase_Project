...
FROM
    product p
INNER JOIN product_category_configuration pcc 
...
INNER JOIN variation_configuration vc 
    ON vo.Variation_Option_Id = vc.Variation_Option_Id
INNER JOIN variant v 
    ON vc.Variant_Id = v.Variant_Id
